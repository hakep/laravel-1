...
@section('content')
    <section class="content" id="create">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item float-lg-right"><a class="nav-link" href="" target="_blank" id="page-link"></a></li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab2">
                <textarea title="ckeditor" name="editor1" id="editor1" cols="45" rows="5"></textarea>
            </div>
